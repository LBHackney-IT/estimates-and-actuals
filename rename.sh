...
echo "Renaming all 'Estimates_And_Actuals' -> '$PASCAL'"
echo "Renaming all 'Estimates_And_Actuals' -> '$CAMEL'"
...
find . -type d -not -path '*/\.git/*' | sed -e "p;s/Estimates_And_Actuals/$PASCAL/" | xargs -n2 mv
find . -type d -not -path '*/\.git/*' | sed -e "p;s/Estimates_And_Actuals/$CAMEL/" | xargs -n2 mv
# file names
...
find . -type f -not -path '*/\.git/*' | sed -e "p;s/Estimates_And_Actuals/$PASCAL/" | xargs -n2 mv
find . -type f -not -path '*/\.git/*' | sed -e "p;s/Estimates_And_Actuals/$CAMEL/" | xargs -n2 mv
# strings
...
find . -type f -not -path '*/\.git/*' -exec sed -i "s/Estimates_And_Actuals/$PASCAL/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/Estimates_And_Actuals/$CAMEL/g" {} \;
