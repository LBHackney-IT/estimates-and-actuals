using AutoFixture;
using EstimatesAndActuals;
using EstimatesAndActuals.Tests;
...
//namespace EstimatesAndActuals.Tests.V1.E2ETests
//{
// For guidance on writing integration tests see the wiki page https://github.com/LBHackney-IT/lbh-estimates-and-actuals/wiki/Writing-Integration-Tests
...
//    /// <returns></returns>
//    private EstimateAndActuals ConstructTestEntity()
//    {
...
//        var apiEntity = JsonConvert.DeserializeObject<EstimateAndActuals>(responseContent);
