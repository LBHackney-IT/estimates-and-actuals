...
namespace EstimatesAndActuals.Tests.V1.Gateways
{
    ...
    public class DynamoDbGatewayTests : DynamoDbIntegrationTests<Startup>
    {
        ...
        {
            var entity = _fixture.Build<EstimateAndActualsDbEntity>()
        ...
        private void InsertDatatoDynamoDB(EstimateAndActualsDbEntity entity)
        {
            DynamoDbContext.SaveAsync<EstimateAndActualsDbEntity>(entity).GetAwaiter().GetResult();
